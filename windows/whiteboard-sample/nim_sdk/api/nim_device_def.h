...
extern"C"
{
	...
	*/
	...
	static const char *kNIMDeviceHeadphone		= "headphone";		/**< int 大于0时标记为耳机设备*/
	...
	*/
	...
	/** @typedef void(*nim_vchat_audio_effect_opt_cb_func)(int id, bool ret, int code, const char *json_extension, const void *user_data)
	  * NIM Device 音效操作结果回调
	  * @param[out] id 音效id
	  * @param[out] ret 操作结果
	  * @param[out] code 错误码
