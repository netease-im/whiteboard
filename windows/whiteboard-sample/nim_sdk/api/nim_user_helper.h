...
private:
	...
	nim_cpp_wrapper_util::Json::Value		expand_;			/**< 用户扩展数据 */
...
/** @fn bool ParseNameCards(const nim_cpp_wrapper_util::Json::Value& namecards_json, std::list<UserNameCard>& namecards)
  * @brief 解析用户名片
