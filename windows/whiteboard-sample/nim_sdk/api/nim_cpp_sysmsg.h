...
public:
	...
	typedef std::function<void(NIMResCode res_code, int unread_count)>	NotifySysmsgResCallback;	/**< 修改系统消息自定义通知回调模板 */
	...
	typedef std::function<void(NIMResCode res_code, int64_t msg_id, int unread_count)>	NotifySingleSysmsgCallback;	/**< 修改（单条）系统消息自定义通知回调模板 */
