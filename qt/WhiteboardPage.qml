...
Window {
    ...
    Rectangle{
        ...
        DragArea {
            ...
            title: "房间号：" + NEMLoginManager.getRoomid()
            roomid: NEMLoginManager.getRoomid()
            nickname: NEMLoginManager.getAccount()
            onCloseClicked: {
                function confirm(){
                    NEMLoginManager.logoutRoom()
                    root.hide()
        ...
        NEMWhiteboard {
            ...
            whiteboardChannelName: NEMLoginManager.getRoomid()
            whiteboardRecord: false
            whiteboardDebug: true
            defaultDownloadPath: WhiteboardHelper.getDefaultDownloadPath()
            whiteboardUrl: NEMLoginManager.getWhiteboardUrl()

            function confirm(){
                NEMLoginManager.logoutChatroom()
                root.hide()
                close.accepted = false
            }
